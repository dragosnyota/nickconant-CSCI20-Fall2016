...
int main() {
    ...
    for (int startHourValue = 1; startHourValue <= endHourValue; ) { // while starting hour value is less than or equal to ending hour value the loop will run
